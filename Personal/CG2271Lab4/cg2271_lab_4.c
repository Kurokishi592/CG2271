...
void initPWM() {
	...
	PORTE->PCR[RED_PIN] = PORT_PCR_MUX(3);  // ALT3 for TPM0_CH4 (Red)
	PORTD->PCR[GREEN_PIN]  = PORT_PCR_MUX(4);  // ALT4 for TPM0_CH5 (Green)
	PORTE->PCR[BLUE_PIN] = PORT_PCR_MUX(3);  // ALT3 for TPM0_CH2 (Blue)
	...
	TPM0->CONTROLS[4].CnSC &= ~TPM_CnSC_MSB_MASK | TPM_CnSC_ELSB_MASK; // Red
	TPM0->CONTROLS[5].CnSC &= ~TPM_CnSC_MSB_MASK | TPM_CnSC_ELSB_MASK; // Green
	TPM0->CONTROLS[2].CnSC &= ~TPM_CnSC_MSB_MASK | TPM_CnSC_ELSB_MASK; // Blue
	TPM0->CONTROLS[4].CnSC |= (TPM_CnSC_MSB(1) | TPM_CnSC_ELSB(1)); // Red
	TPM0->CONTROLS[5].CnSC |= (TPM_CnSC_MSB(1) | TPM_CnSC_ELSB(1)); // Green
	TPM0->CONTROLS[2].CnSC |= (TPM_CnSC_MSB(1) | TPM_CnSC_ELSB(1)); // Blue
